function f = calculate_spatial_kernel_anygeo_MSEE(geoflags,in_matrix,ddr_iof,ddr_lat,ddr_lon,sb,num_rows,num_cols,num_bands,size_kernel,lat_number,lon_number,c_num_rows,c_num_cols,pix_spacing, mro_position,pix_positions,pix_normals, use_mex)
